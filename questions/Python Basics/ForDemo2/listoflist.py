celestial = [['sun', 'sirius', 'vega'], ['Haileys', 'Encke', 'Lexell', 'West'], ['Earth', 'Mars', 'Jupiter', 'Saturn', 'Uranus'], ['Milkyway', 'Whirlpool', 'Black Eye', 'Starbust']] 
print "Celestial Objects are ", celestial 
...
print "Modified Galaxies are ", celestial[3]

# b) Find the number of planets in your list 
print "Number of planets are ", len(celestial[2])

# c) What is the name of the last comet in your list? 
cometemp = celestial[1]
print "Last comet is ", cometemp[-1]
...
print "Replaced Planets are ", celestial[2]
...
print s , " Lists exists that have same number of elements______________________________________", numberlist
...
print "Total number of satellites is ", sattot 
...
print "Modified Celestial Star List is ", celestial[0]
...
planetemp[1]='Pandora'
celestial[2] = planetemp
print "Modified Celestial Planet list is ", celestial[2]
...
print "Earth occurs ", celestial[2].count('Earth'), " times"

# k) Create a range list having the exact number of elements as the total number of satellites 

print "Total number of satelites calculated in #g above is ", sattot
...
print "Combined star list is", mystars 

#n) Do the following "slicing" 

   #(i) print the 3rd, 4th and 5th element
print "Printing 3rd, 4th and 5th element: ", mystars[2:5] 

   #(ii) print all elements starting from the 3rd element 
print "print all elements starting from the 3rd element : ", mystars[2:] 
   #(iii) print from beginning until the 4th element 
print "print from beginning until the 4th element: ", mystars[:4] 

   #(iv) print all 
print "print all: ", mystars[:] 
